...
def initialize_parameters():
    ...
    # initializes W1 randomly as a 12 x 12 matrix
    W5 = tf.compat.v1.get_variable("W5", [12,12], initializer = tf.contrib.layers.xavier_initializer(seed = 1))
    # initializes b as zeros as a 12 x 1 vector
    b5 = tf.compat.v1.get_variable("b5", [12,1], initializer = tf.zeros_initializer())
...
def optimize_params(X_train, Y_train, X_dev, Y_dev, X_test, Y_test, learning_rate, num_epochs, minibatch_size):
    ...
    with tf.compat.v1.Session() as sess:
        ...
        c = forward_prop(Xtf_test, parameters).eval(session=sess)       
